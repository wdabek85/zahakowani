        ...
        <div class="product-caption-bottom">
            <?php
             ...
             if ($current_day >= 1 && $current_day <= 3) { 
                 if ($current_hour < 14) {
                     $delivery_message = '<span class="buy-today-span">Dostawa jutro.</span>';
                 } else {
                     $delivery_message = '<span class="buy-today-span">Dostawa pojutrze.</span>';
                 }
             } elseif ($current_day == 4) { 
                 if ($current_hour < 14) {
                     $delivery_message = '<span class="buy-today-span">Dostawa Jutro.</span>';
                 } else {
                     $delivery_message = '<span class="buy-today-span">Dostawa w poniedziałek.</span>';
                 }
             } elseif ($current_day == 5) { 
                 if ($current_hour < 14) {
                     $delivery_message = '<span class="buy-today-span">Dostawa w poniedziałek.</span>';
                 } else {
                     $delivery_message = '<span class="buy-today-span">Dostawa we wtorek.</span>';
                 }
             } elseif ($current_day == 6 || $current_day == 0) { 
                 $delivery_message = '<span class="buy-today-span">Dostawa we wtorek.</span>';
             } 

            echo '<p class="categry-delivery-info">' . $delivery_message . '</p>';
            autozpro_add_quantity_field();
            woocommerce_template_loop_add_to_cart();
            echo '<p class="payment-info">Płatności obsługuje:</p>';
            echo '<img class="payment-info-banner" src="http://autohakiautozpro.local/wp-content/themes/autozpro-child/assets/flagi_Przelewy24_1.png" alt="payment-info">';
            echo '<a class="order-phone" href="tel:+48 536731515">Zamów Telefonicznie <br class ="desktop-break">+48 536 731 515</a>';
...
if (!function_exists('autozpro_woocommerce_single_content_info_end')) {
    function autozpro_woocommerce_single_content_info_end() {
        ...
        if ($current_day >= 1 && $current_day <= 3) { 
            if ($current_hour < 14) {
                $delivery_message = 'Kup do 14:00, <span class="buy-today-span">dostawa następnego dnia.</span>';
            } else {
                $delivery_message = 'Kup teraz, <span class="buy-today-span">dostawa pojutrze.</span>';
            }
        } elseif ($current_day == 4) { 
            if ($current_hour < 14) {
                $delivery_message = 'Kup do 14:00, <span class="buy-today-span">dostawa następnego dnia.</span>';
            } else {
                $delivery_message = 'Kup teraz, <span class="buy-today-span">dostawa w poniedziałek.</span>';
            }
        } elseif ($current_day == 5) { 
            if ($current_hour < 14) {
                $delivery_message = 'Kup do 14:00, <span class="buy-today-span">dostawa w poniedziałek.</span>';
            } else {
                $delivery_message = 'Kup teraz, <span class="buy-today-span">dostawa we wtorek.</span>';
            }
        } elseif ($current_day == 6 || $current_day == 0) { 
            $delivery_message = 'Kup dziś, <span class="buy-today-span">dostawa we wtorek.</span>';
        }

        echo '<p class="payment-info">Płatności obsługuje:</p>';
        echo '<img class="payment-info-banner" src="http://autohakiautozpro.local/wp-content/themes/autozpro-child/assets/flagi_Przelewy24_1.png" alt="payment-info">';
        echo '<a class="order-phone" href="tel:+48 536731515">Zamów Telefonicznie +48 536 731 515</a>';
        echo '<p class="delivery-info">' . $delivery_message . '</p>';
        echo '<button id="open-shipping-panel" class="button shipping-info-button">Dostawa i zwroty</button>';
        echo '</div>';
    }
}
