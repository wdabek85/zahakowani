...
<p><?php echo wp_kses_post( __( 'If every plugin user did it, I could devote myself fully to working on this plugin. Thanks everyone!', 'omnibus' ) ); ?></p>
 <p class="iworks-rate-center"><a href="https://ko-fi.com/iworks/?utm_source=<?php echo esc_attr( $args['slug'] ); ?>&utm_medium=widget-donate" target="_blank" class="iworks-rate-button iworks-rate-button--blue dashicons-heart"><?php echo esc_html( __( 'Provide me a coffee', 'omnibus' ) ); ?></a></p>
