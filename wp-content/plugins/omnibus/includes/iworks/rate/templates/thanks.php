	...
	<div class="<?php echo esc_attr( implode( ' ', $args['classes'] ) ); ?>">
		...
		?>
			...
			/* translators: %s is a plugin name wrapped by strong html tag */
				esc_html( __( 'Thank you for using our plugin %s!', 'omnibus' ) ),
...
?>
		<div class="iworks-rate-buttons">
			<a data-action="get-help" href="<?php echo esc_url( $args['support_url'] ); ?>/#new-post" target="_blank" class="iworks-rate-button iworks-rate-button--green" ><?php echo esc_html( __( 'Get help', 'omnibus' ) ); ?></a>
<?php if ( intval( $args['rated'] ) === 0 ) { ?>
			<a data-action="add-review" href="<?php echo esc_url( $args['support_url'] ); ?>/reviews/?rate=5#new-post" target="_blank" class="iworks-rate-button iworks-rate-button--green" ><?php echo esc_html( __( 'Add review', 'omnibus' ) ); ?></a>
<?php } ?>
			<a data-action="donate" href="https://ko-fi.com/iworks/?utm_source=<?php echo esc_url( $args['slug'] ); ?>&utm_medium=notice-thanks" target="_blank" class="iworks-rate-button iworks-rate-button--green dashicons-heart" ><?php echo esc_html( __( 'Provide us a coffee', 'omnibus' ) ); ?></a>
<?php if ( intval( $args['rated'] ) === 0 ) { ?>
